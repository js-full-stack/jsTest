...
// // const blueEyeColor = users.filter(user => user.eyeColor === 'blue');
// // console.table(blueEyeColor);
// const getEmailAddress = array => array.map(({ email }) => email);
...
//   },
// ];
// const womans = users.filter(user => user.gender === 'female');
// const mans = users.filter(user => user.gender === 'male');
// console.log(womans);
// console.log(mans);

// const nameMans = mans.map(man => man.name);
// const nameWomans = womans.map(woman => woman.name);
// console.log(nameMans);
// console.log(nameWomans);
...
//   array.filter(({ gender }) => gender === gend).map(({ name }) => name);
...
// console.log(getUsersWithAge(users, 10, 25));
...
// const skillsList = users
//   .reduce((allSkills, skill) => {
//     // allSkills.push(...skill.skills);

//     return allSkills.concat(...skill.skills);
//   }, [])
//   .filter((skill, idx, skills) => skills.indexOf(skill) !== idx)
//   .sort();
